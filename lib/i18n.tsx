...
const AR: Record<string, string> = {
  ...
  "We couldn't load this review request.": "تعذّر تحميل طلب التقييم.",
  "We couldn't submit your review.": "تعذّر إرسال تقييمك.",
  "Review unavailable": "التقييم غير متاح",
  "Try again": "حاول مرة أخرى",
  "This review request has expired": "انتهت صلاحية طلب التقييم",
  "Thank you for choosing Bubbleit. This review can no longer be changed.": "شكراً لاختيارك ببلت. لم يعد من الممكن تعديل هذا التقييم.",
  "Thank you for your feedback": "شكراً لملاحظاتك",
  "Your review was submitted and is awaiting moderation.": "تم إرسال تقييمك وهو بانتظار المراجعة.",
  "out of 5 stars": "من 5 نجوم",
  "Completed service": "خدمة مكتملة",
  "How was your wash?": "كيف كانت خدمة الغسيل؟",
  "Choose a star rating": "اختر تقييماً بالنجوم",
  "star": "نجمة",
  "stars": "نجوم",
  "Notes (optional)": "ملاحظات (اختياري)",
  "Tell us what went well or what we can improve…": "أخبرنا بما أعجبك أو بما يمكننا تحسينه…",
  "characters used": "حرف مستخدم",
  "Submitting…": "جارٍ الإرسال…",
  "Submit review": "إرسال التقييم",
  "Select a rating to continue.": "اختر تقييماً للمتابعة.",
  // Navbar / footer
  "Services": "الخدمات",
  "Store": "المتجر",
  "Download": "التطبيق",
  ...
  "Cancel this store order?": "هل تريد إلغاء طلب المتجر؟",
  "Order cancelled. Your full refund request was sent to our team.": "تم إلغاء الطلب وإرسال طلب استرداد كامل إلى فريقنا.",
  "Order cancelled. You were not charged.": "تم إلغاء الطلب ولم يتم تحصيل أي مبلغ.",
  "Refund": "الاسترداد",
  ...
  "Reconciliation Required": "تتطلب المطابقة",
  "Rejected": "مرفوض",
  "Processed": "تمت المعالجة",
  "Could not cancel the store order.": "تعذّر إلغاء طلب المتجر.",
  "The unpaid order reservation ended. Your products are still in the cart so you can check out again.": "انتهى حجز الطلب غير المدفوع، وما زالت المنتجات في سلتك لتتمكن من إتمام الطلب من جديد.",
