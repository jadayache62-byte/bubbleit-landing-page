...
const AR: Record<string, string> = {
  ...
  "Bubbleit Rewards": "مكافآت ببلت",
  "Wash 5 times. Your 6th wash is free.": "اغسل ٥ مرات، والغسلة السادسة مجاناً.",
  "Every completed wash moves you closer. Choose the same service and vehicle class five times, then enjoy the matching base wash on us.":
    "كل غسلة مكتملة تقرّبك من المكافأة. اختر الخدمة نفسها وفئة المركبة نفسها خمس مرات، ثم استمتع بالغسلة الأساسية المطابقة مجاناً.",
  "Start earning washes": "ابدأ بجمع الغسلات",
  "Your path to a free wash": "طريقك إلى غسلة مجانية",
  "Five paid washes unlock one free wash": "خمس غسلات تفتح غسلة مجانية",
  "Wash": "غسلة",
  "Free matching wash": "غسلة مطابقة مجانية",
  "Progress stays separate for each service and vehicle class.": "يُحتسب التقدم بشكل مستقل لكل خدمة وفئة مركبة.",
  "The free reward covers the base wash; extras remain optional.": "تغطي المكافأة الغسلة الأساسية، وتبقى الإضافات اختيارية.",
  "Your 6th wash is on us": "غسلتك السادسة علينا",
  "See how it works": "اعرف كيف تعمل",
  "Unlock every 6th matching wash": "افتح كل غسلة سادسة مطابقة",
  "How rewards work": "كيف تعمل المكافآت",
  "Close rewards details": "إغلاق تفاصيل المكافآت",
  "Five matching washes. The next one’s on us.": "خمس غسلات مطابقة، والتالية علينا.",
  "Book the same service for the same vehicle class five times. We’ll automatically unlock the matching base wash as your reward.": "احجز الخدمة نفسها لفئة المركبة نفسها خمس مرات، وسنفتح لك الغسلة الأساسية المطابقة تلقائياً كمكافأة.",
  "Book as usual": "احجز كالمعتاد",
  "Each completed eligible wash adds one stamp automatically.": "تضيف كل غسلة مؤهلة ومكتملة ختمًا واحدًا تلقائياً.",
  "Keep it matching": "حافظ على التطابق",
  "Use the same service and vehicle class to build that reward.": "اختر الخدمة نفسها وفئة المركبة نفسها لبناء هذه المكافأة.",
  "Enjoy wash six": "استمتع بالغسلة السادسة",
  "Your matching base wash is free; extras stay optional and payable.": "غسلتك الأساسية المطابقة مجانية، وتبقى الإضافات اختيارية ومدفوعة.",
  "Reward benefits": "مزايا المكافأة",
  "Tracked automatically": "تُحتسب تلقائياً",
  "Progress never expires": "التقدم لا تنتهي صلاحيته",
  "No promo code needed": "لا تحتاج إلى رمز خصم",
  "Eligible paid washes earn progress. Membership-covered and reward-covered washes do not. Rewards cover the base wash only.": "الغسلات المدفوعة المؤهلة تضيف إلى تقدمك، أما غسلات العضوية والمكافآت فلا تُحتسب. تغطي المكافأة الغسلة الأساسية فقط.",
  "Maybe later": "ربما لاحقاً",
  "Choose my wash": "اختر غسلتي",
  "Book toward my reward": "احجز نحو مكافأتي",
  "Start earning my free wash": "ابدأ بجمع غسلاتي المجانية",
  "Salon": "صالون",
  "Book →": "احجز ←",
  "Rewards": "المكافآت",
  "Loyalty": "الولاء",
  "Your free-wash progress": "تقدمك نحو الغسلة المجانية",
  "View all rewards": "عرض جميع المكافآت",
  "View rewards": "عرض المكافآت",
  "You have a free wash ready": "لديك غسلة مجانية جاهزة",
  "Wash 5, get the 6th free": "اغسل ٥ واحصل على السادسة مجاناً",
  "Every eligible wash brings you closer. Progress never expires.": "كل غسلة مؤهلة تقرّبك، وتقدمك لا تنتهي صلاحيته.",
  "The loyalty program is paused. Your progress and rewards are safe.": "برنامج الولاء متوقف مؤقتاً، وتقدمك ومكافآتك محفوظة.",
  "Free washes": "غسلات مجانية",
  "My rewards": "مكافآتي",
  "Progress is separate for every service and vehicle type.": "يُحتسب التقدم بشكل مستقل لكل خدمة ونوع مركبة.",
  "Book toward a reward": "احجز نحو مكافأتك",
  "Program paused": "البرنامج متوقف مؤقتاً",
  "Your earned rewards and progress remain available when the program resumes.": "ستبقى مكافآتك وتقدمك محفوظين عند استئناف البرنامج.",
  "free": "مجانية",
  "Your matching free base wash is ready.": "غسلتك الأساسية المجانية المطابقة جاهزة.",
  "more matching washes to your reward": "غسلات مطابقة إضافية للحصول على مكافأتك",
  "Use free wash": "استخدم الغسلة المجانية",
  "Book this wash": "احجز هذه الغسلة",
  "Start your first reward": "ابدأ مكافأتك الأولى",
  "Complete five matching washes to unlock the sixth base wash free.": "أكمل خمس غسلات متطابقة لتحصل على الغسلة الأساسية السادسة مجاناً.",
  "Reward history": "سجل المكافآت",
  "Your earned rewards will appear here.": "ستظهر مكافآتك المكتسبة هنا.",
  "Reserved": "محجوزة",
  "Redeemed": "مستخدمة",
  "Your exact progress and matching rewards will be applied at checkout.": "سيظهر تقدمك الدقيق وتُطبّق مكافآتك المطابقة عند الدفع.",
  "Sign in at checkout to see your exact free-wash progress.": "سجّل الدخول عند الدفع لرؤية تقدمك الدقيق نحو الغسلة المجانية.",
  "Matching rewards are selected automatically. The free reward covers the base wash; add-ons and products stay payable.": "يتم اختيار المكافآت المطابقة تلقائياً. تغطي المكافأة الغسلة الأساسية، وتبقى الإضافات والمنتجات مدفوعة.",
  "Free base wash": "غسلة أساسية مجانية",
  "Promo codes cannot be combined with a free-wash reward.": "لا يمكن دمج رموز الخصم مع مكافأة الغسلة المجانية.",
  "Free base wash + payment for extras": "غسلة أساسية مجانية + دفع قيمة الإضافات",
  "Loyalty reward — no payment required": "مكافأة ولاء — لا يلزم الدفع",
  "Book now": "احجز الآن",
  "issued": "متاحة",
  "reserved": "محجوزة",
  "SEDAN": "صالون",
  ...
  "Cash due": "الدفع النقدي مستحق",
  "Cash payment": "الدفع النقدي",
  "Cancel membership": "إلغاء الاشتراك",
  "Cancel this unpaid cash membership?": "هل تريد إلغاء هذا الاشتراك النقدي غير المدفوع؟",
  "Membership cancelled. You were not charged.": "تم إلغاء الاشتراك ولم يتم خصم أي مبلغ.",
  "Could not cancel the membership.": "تعذّر إلغاء الاشتراك.",
  "Booking confirmed — cash due": "تم تأكيد الحجز — الدفع النقدي مستحق",
  "Confirm cash booking": "تأكيد الحجز النقدي",
  "Your booking can proceed. Pay the full amount in cash to the driver when they arrive; this status updates after cash is recorded.": "يمكن متابعة حجزك. ادفع المبلغ كاملاً نقداً للسائق عند وصوله؛ وستتحدث الحالة بعد تسجيل الدفعة.",
  "Your membership is reserved and remains inactive until the full cash payment is recorded.": "تم حجز اشتراكك وسيبقى غير نشط حتى تسجيل الدفعة النقدية كاملة.",
  "Your order is confirmed for delivery. Pay the full amount in cash when the team arrives.": "تم تأكيد طلبك للتوصيل. ادفع المبلغ كاملاً نقداً عند وصول الفريق.",
  "Cash is due. Your purchase can proceed and will update after an authorized team member records the full payment.": "الدفع النقدي مستحق. يمكن متابعة طلبك، وستتحدث الحالة بعد أن يسجّل أحد أعضاء الفريق المخوّلين الدفعة كاملة.",
  "Cash due. Your booking can proceed and this status will update after the full payment is recorded.": "الدفع النقدي مستحق. يمكن متابعة حجزك، وستتحدث الحالة بعد تسجيل الدفعة كاملة.",
  "Cash due. This membership remains inactive until an authorized team member records the full payment.": "الدفع النقدي مستحق. يبقى الاشتراك غير نشط حتى يسجّل أحد أعضاء الفريق المخوّلين الدفعة كاملة.",
  "Cash due. This membership activates after an authorized team member records the full payment.": "الدفع النقدي مستحق. يتفعّل الاشتراك بعد أن يسجّل أحد أعضاء الفريق المخوّلين الدفعة كاملة.",
  "Online payment is temporarily unavailable. Pay the full amount to the assigned driver or team member when your service or delivery arrives. Membership benefits activate only after cash is recorded.": "الدفع الإلكتروني غير متاح مؤقتاً. ادفع المبلغ كاملاً للسائق المعيّن أو عضو الفريق عند وصول الخدمة أو الطلب. لا تتفعّل مزايا الاشتراك إلا بعد تسجيل الدفعة النقدية.",
  "Payment method": "طريقة الدفع",
  "Card / Apple Pay": "البطاقة / Apple Pay",
  "Direct Debit Card (QPAY)": "بطاقة الخصم المباشر (QPAY)",
  "Continue directly to QPAY debit-card checkout.": "تابع مباشرة إلى صفحة دفع بطاقة الخصم عبر QPAY.",
  "Secure SkipCash checkout with cards and Apple Pay when available.": "دفع آمن عبر SkipCash بالبطاقات وApple Pay عند توفرها.",
  ...
  "Booking number, service, or vehicle": "رقم الحجز أو الخدمة أو المركبة",
  ...
  "of": "من",
  "bookings": "حجوزات",
  "No bookings match your filters.": "لا توجد حجوزات تطابق عوامل التصفية.",
  "Cancelling…": "جارٍ الإلغاء…",
  "Could not cancel the booking.": "تعذّر إلغاء الحجز.",
  "Booking cancelled. You were not charged.": "تم إلغاء الحجز ولم يتم تحصيل أي مبلغ.",
